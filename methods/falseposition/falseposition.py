import math
from utils.file_utils import create_out_header, read_function, save_results, save_iter, compute_max_iterations

INPUT_PATH = "falseposition/input.txt"
OUTPUT_PATH = "falseposition/result.txt"
