import math
from utils.file_utils import save_iter, create_out_header, read_matrix, save_results, compute_max_iterations

INPUT_PATH = "gauss-elimination/input.txt"
OUTPUT_PATH = "gauss-elimination/result.txt"
