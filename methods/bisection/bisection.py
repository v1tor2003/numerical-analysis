import math
from utils.file_utils import save_iter, create_out_header, read_function, save_results, compute_max_iterations

INPUT_PATH = "bisection/input.txt"
OUTPUT_PATH = "bisection/result.txt"
